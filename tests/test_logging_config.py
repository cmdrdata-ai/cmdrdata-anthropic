...
from cmdrdata_anthropic.logging_config import (
    StructuredFormatter, SecurityFormatter, LoggingConfig, RequestLogger,
    log_performance, get_logger, configure_logging, DEFAULT_LOGGING_CONFIG
)
...
class TestSecurityFormatter:
    ...
    def test_api_key_sanitization(self):
        ...
        test_cases = [
            ("API key: sk-abcdefghijklmnopqrstuvwxyz1234567890123456", "API key: sk-***REDACTED***"),
            ("Token: tk-1234567890abcdef", "Token: tk-***REDACTED***"),
            ("Authorization: Bearer sk-test123456789012345678901234567890123456", "Authorization: Bearer ***REDACTED***"),
    ...
    def test_request_logger_context(self):
        ...
        with RequestLogger(logger, **context):
            ...
            test_record = current_factory(
                "test_logger", logging.INFO, "/path/to/file.py", 42,
                "Test message", (), None
            )
